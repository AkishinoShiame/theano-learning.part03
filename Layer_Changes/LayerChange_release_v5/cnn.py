...
class CNN(object):
    ...
    def __init__(self, rng, input, nkerns, batch_size):
        ...
        self.layer0_input = input.reshape((batch_size, 1, 288, 512))
        ...
        self.layer0 = LeNetConvPoolLayer(
            ...
            image_shape=(batch_size, 1, 288, 512),
            filter_shape=(nkerns[0], 1, 9, 17), # 280 496
            poolsize=(2, 2)
        )
        ...
        self.layer1 = LeNetConvPoolLayer(
            ...
            image_shape=(batch_size, nkerns[0], 140, 248),
            filter_shape=(nkerns[1], nkerns[0], 9, 17),# 132 232
            poolsize=(2, 2)
        )
        # Construct the second convolutional pooling layer
        # filtering reduces the image size to (12-5+1, 12-5+1) = (8, 8)
        ...
        self.layer2 = LeNetConvPoolLayer(
            ...
            image_shape=(batch_size, nkerns[1], 66, 116),
            filter_shape=(nkerns[2], nkerns[1], 9, 17), # 58 100
            poolsize=(2, 2)
        )
        # 120/8 = 15 64/8 =8
        ...
        self.layer4 = LogisticRegression(input=self.layer3.output, n_in=500, n_out=20)
