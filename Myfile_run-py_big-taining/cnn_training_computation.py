...
def fit(data, labels, filename = 'weights_v6_.pkl'):
    fit_predict(data, labels, filename = filename, action = 'fit') 

def re_fit(data, labels, filename = 'weights_v6_.pkl'):
    fit_predict(data, labels, filename = filename, action = 'refit') 

def predict(test_dataset, filename = 'weights_v6.pkl' ):
